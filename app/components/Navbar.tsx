  ...
  >
    ...
    />
          ...
          <div className="hidden md:flex items-center space-x-8 lg:space-x-10 text-base lg:text-lg font-medium">
            ...
            <button className="bg-amber-500 text-black px-5 py-2 rounded-full font-semibold hover:bg-amber-400 transition shadow-lg">
              Order Now
            </button>
          </div>
          ...
          <button
            ...
            className="md:hidden text-3xl p-2 rounded-lg hover:bg-white/10 transition focus:outline-none"
        ...
        {open && (
          ...
          >
            <div className="flex flex-col items-center gap-6 py-8 text-lg font-medium text-white">
              ...
              <button className="mt-2 bg-amber-500 text-black px-8 py-3 rounded-full font-semibold hover:bg-amber-400 transition shadow-lg">
                Order Now
              </button>
            </div>
          </motion.div>
